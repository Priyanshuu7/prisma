...
export type PostWhereInput = {
  ...
  int?: Prisma.IntFilter<"Post"> | number
...
export type PostScalarWhereWithAggregatesInput = {
  ...
  int?: Prisma.IntWithAggregatesFilter<"Post"> | number
...
export type PostOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"int" | "title" | "desc" | "user_id" | "createdAt" | "comment_count", ExtArgs["result"]["post"]>
...
export interface PostDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `int`
   * const postWithIntOnly = await prisma.post.findMany({ select: { int: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Posts and only return the `int`
   * const postWithIntOnly = await prisma.post.createManyAndReturn({
   *   select: { int: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Posts and only return the `int`
   * const postWithIntOnly = await prisma.post.updateManyAndReturn({
   *   select: { int: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PostFieldRefs {
  readonly int: Prisma.FieldRef<"Post", 'Int'>
